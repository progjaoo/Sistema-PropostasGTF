# Documentacao do Sistema de Propostas

Este diretorio centraliza as guidelines, padroes tecnicos e regras funcionais do Sistema de Propostas.

## Identificacao do Projeto

- Nome: Sistema de Propostas
- Tipo: WEB + API
- Stack principal: TypeScript, React, Vite, Express, Prisma, PostgreSQL, Docker e PNPM Workspaces.
- Objetivo: gerenciar empresas, programas, produtos, anunciantes e propostas comerciais com perfis ADMIN e COMERCIAL.

## Indice

1. [Visao geral](./01-visao-geral.md)
2. [Stack e tipo do projeto](./02-stack-e-tipo.md)
3. [Arquitetura e pastas](./03-arquitetura-e-pastas.md)
4. [Guidelines de frontend](./04-frontend-guidelines.md)
5. [Guidelines de backend e API](./05-backend-api-guidelines.md)
6. [Banco de dados e Prisma](./06-banco-de-dados.md)
7. [Autenticacao, perfis e permissoes](./07-autenticacao-perfis-permissoes.md)
...
2. Leia [Stack e tipo do projeto](./02-stack-e-tipo.md).
